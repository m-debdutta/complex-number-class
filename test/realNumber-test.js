...
describe('Testing add() ', function() {
  ...
  it('should display the addition of two real number of opposite sign', function() {
    const four = new RealNumber(4); 
...
describe('Testing multiply()', function() {
  ...
  it('should display the multiplication of two real numbers of opposite sign', function() {
